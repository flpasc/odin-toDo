...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"renderContent\": () => (/* binding */ renderContent)\n/* harmony export */ });\n/* harmony import */ var _renderTodoItem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderTodoItem */ \"./src/renderTodoItem.js\");\n\n\nconst renderContent = () => {\n\tconst storage = JSON.parse(window.localStorage.getItem(\"todoArray\"));\n\tstorage.forEach((todo) => {\n\t\t(0,_renderTodoItem__WEBPACK_IMPORTED_MODULE_0__.renderTodoItem)(todo);\n\t});\n};\n\n\n//# sourceURL=webpack://odin-todo/./src/renderContent.js?");
